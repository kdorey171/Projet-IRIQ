...
int main()
{
    ...
    block_ligne.setPosition(Vector2f(0.f,120.f+0*80.f-28.f));
    block_ligne.setFillColor(sf::Color::Red);
    ligne_fight.push_back(block_ligne);

    block_ligne.setPosition(Vector2f(0.f,120.f+1*80.f-23.f));
    block_ligne.setFillColor(sf::Color::Red);
    ligne_fight.push_back(block_ligne);

    block_ligne.setPosition(Vector2f(0.f,120.f+2*80.f-18.f));
    block_ligne.setFillColor(sf::Color::Red);
    ligne_fight.push_back(block_ligne);

    block_ligne.setPosition(Vector2f(0.f,120.f+3*80.f-13.f));
    block_ligne.setFillColor(sf::Color::Red);
    ligne_fight.push_back(block_ligne);

    block_ligne.setPosition(Vector2f(0.f,120.f+4*80.f-8.f));
    block_ligne.setFillColor(sf::Color::Red);
    ligne_fight.push_back(block_ligne);
    ...
    /// Création des premiers batiments de départ

    Vector2f size_vessel = Vector2f(65.f,65.f); // Taille générique des bâtiments sur la carte.
    ...
    //vessel_player_1->set_color(sf::Color::Red);
    //vessel_player_1->position_vessel.setTexture(&textureLoader.getTexture("bat_unit3")); // Autre possibilité sans méthodes.
    vessel_player_1->set_texture("bat_unit1");
    vessel_player_1->set_position(Vector2f(250.f,120.f+2*80.f-18.f-10.f));
    ...
    //vessel_player_IA->position_vessel.setTexture(&textureLoader.getTexture("bat_unit3")); // Autre possibilité sans méthodes.
    vessel_player_IA->set_texture("bat_unit1");
    vessel_player_IA->set_position(Vector2f(770.f,120.f+2*80.f-18.f-10.f));
        ...
        if (statut == 1) {
            ...
            if (touche.left == true)
            {
				...
				//Creation des batiments après séléctions dans le coin supérieur gauche de l'écran
                    ...
                    {
                        vessel_select=true; // et que j'en ai pas déjà selectionné un...
